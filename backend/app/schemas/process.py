...
class ChunkingOptions(BaseModel):
    ...
    semantic_threshold: Optional[float] = Field(default=0.5, description="The similarity threshold for semantic chunking (0.0 to 1.0).")
    separators: Optional[List[str]] = Field(default=None, description="List of separators for recursive chunking.")
...
class Chunk(BaseModel):
    ...
    token_count: Optional[int] = Field(None, description="The estimated token count of the chunk.")
